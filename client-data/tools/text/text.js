...
(function () { //Code isolation
    ...
    function startEdit() {
        ...
        input.style.left = (!curText.newText ? (curText.x) : (curText.x + BOARD_X_BASE)) + 'px';
        input.style.top = (!curText.newText ? (curText.y) : (curText.y + BOARD_Y_BASE)) - 20 + 'px';
        input.focus();
    ...
    function textChangeHandler(evt) {
        if (evt.which === 13) { // enter
            ...
            if (!curText.newText) {
                curText.x -= BOARD_X_BASE;
                curText.y -= BOARD_Y_BASE;
                curText.newText = true;
            }
            stopEdit();
            startEdit();
